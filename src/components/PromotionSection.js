                ...
                <div className="promo">
                    ...
                    <div className="promo__message-container"  style={toStyleObj('background-image: url(\'' + withPrefix(_.get(this.props, 'data.config.bg_image_product', null)) + '\')')}>
                        ...
                        {_.get(section, 'cta', null) && ((() => {
                            ...
                            return (
                                <Link className={classNames('link', {'link--promo--filled': cta_style === 'primary', 'link--promo--transparent': cta_style === 'secondary', 'link--promo--simple ': cta_style === 'link'})} href={_.get(section, 'cta.url', null)}>
