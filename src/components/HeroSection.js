            ...
            <section className="hero bg-color" data-id={_.get(section, 'section_id', null)}>
                ...
                <div className="link-group">
                  {_.map(_.get(section, 'actions', null), (action, action_idx) => {
                      ...
                      return (
                        <Link key={action_idx} href={withPrefix(_.get(action, 'url', null))} className={classNames('link', {'link--filled': action_style === 'primary', 'link--transparent': action_style === 'secondary', 'link--simple ': action_style === 'link'})}>
